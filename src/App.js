  ...
  render() {
    return (
      <div className="App flex flex-col m-4 ">
        ...
        <h2 className="text-pink-400">My Github Contributions:</h2>
        <div className="flex flex-row items-center justify-evenly" >
          <GitHubCalendar username={this.state.currentUser} />
        </div>
...
// https://grubersjoe.github.io/react-github-calendar/ - React Github Calendar Component
